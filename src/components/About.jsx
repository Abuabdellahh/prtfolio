      ...
      <div className="max-w-7xl mx-auto sm:px-16 px-6 flex flex-row items-start gap-5">
        ...
        <div>
          ...
          <motion.p
            ...
            className="mt-4 text-slate-950 text-[15px] max-w-3xl leading-[30px]"
          >
            ...
            TypeScript. With a Bachelor of Science in GIS from Wolega University
            and a Full-Stack Web Development certification from Evangadi Tech, I
            have successfully completed various projects such as Netflix,
            Amazon, and Apple clones, as well as a personal portfolio website.
            My experience also extends to improving mobile user engagement,
            implementing RESTful APIs, and participating in Agile development. I
            am fluent in Amharic, English, and Arabic, and I continuously strive
            to expand my knowledge and skills. Currently, I am exploring
            TypeScript and AWS, and I am open to junior developer roles where I
